      ...
      <div className="container px-4 z-10 flex flex-col items-center">
        <AnimatePresence>
          ...
          {animationStep >= 3 && (
            ...
            >
              <div className="bg-white/10 backdrop-blur-lg dark:bg-[rgba(28,28,30,0.85)] dark:backdrop-blur-xl p-6 rounded-xl shadow-md dark:shadow-lg card-glow">
                <div className="bg-blue-600 dark:bg-blue-600 w-12 h-12 rounded-full flex items-center justify-center mb-4">
                  <Shield className="text-white" size={22} />
                </div>
                <h3 className="text-xl font-bold text-white mb-2">Secure Data</h3>
                <p className="text-blue-100 dark:text-gray-300">Your medical records are encrypted and secured using advanced blockchain technology</p>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-lg dark:bg-[rgba(28,28,30,0.85)] dark:backdrop-blur-xl p-6 rounded-xl shadow-md dark:shadow-lg card-glow">
                ...
                <p className="text-blue-100 dark:text-gray-300">You control who has access to your medical information at all times</p>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-lg dark:bg-[rgba(28,28,30,0.85)] dark:backdrop-blur-xl p-6 rounded-xl shadow-md dark:shadow-lg card-glow">
                ...
                <p className="text-blue-100 dark:text-gray-300">No single point of failure ensures your data remains accessible when you need it</p>
              </div>
            </motion.div>
          )}
